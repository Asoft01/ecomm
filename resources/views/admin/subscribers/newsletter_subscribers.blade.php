          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ url('admin/export-newsletter-emails') }}" style="max-width: 150px; float:right; display: inline-block;" class="btn btn-block btn-success"> Export </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="newsletter_subscribers" class="table table-bordered table-hover">
                  <thead>
                  <tr>
                    <th>ID</th>
                    <th>Email</th>
                    ...
                    @foreach($newsletter_subscribers as $subscriber)
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                &nbsp; &nbsp;
                                <a title="Delete Subscriber" href="javascript:void(0)" class="confirmDelete" record="subscriber" recordid="{{ $subscriber['id'] }}"><i class="fas fa-trash" style="color:red"></i></a>
                            </td>
                        </tr>
                    @endforeach
                  </tbody>
