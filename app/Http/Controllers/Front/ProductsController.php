...
class ProductsController extends Controller
{
    ...
    public function wishlist(){
        ...
        $meta_title = "Wish List - Ecommerce Website";
        $meta_description = "View Wish List of E-Commerce Webiste";
    ...
    public function updateWishlist(Request $request){
        if($request->ajax()){
            $data = $request->all();
            // echo "<pre>"; print_r($data); die;
            // echo $countWishlist = Wishlist::countWishlist($data['product_id']); die;
